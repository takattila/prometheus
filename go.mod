module github.com/takattila/prometheus
...
require (
	...
	github.com/pact-foundation/pact-go v1.4.3 // indirect
	...
	github.com/zimmski/go-leak v0.0.0-20151016212241-a11b0b936d24 // indirect
